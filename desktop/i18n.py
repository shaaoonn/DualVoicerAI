...
_TRANSLATIONS = {
    ...
    "set_nav_shortcuts":    {"en": "⌨️  Shortcuts",     "bn": "⌨️  শর্টকাট"},
    "set_nav_subscription": {"en": "🔑  Subscription",  "bn": "🔑  সাবস্ক্রিপশন"},
    "set_nav_about":        {"en": "ℹ️  About",         "bn": "ℹ️  সম্পর্কে"},

    # ─────────────────────── Settings panel - Shortcuts tab ─────────────────────
    "set_sec_sc_main":      {"en": "🌐 Main App (Global)",
                             "bn": "🌐 মূল অ্যাপ (গ্লোবাল)"},
    "set_sec_sc_tools":     {"en": "🎨 Editor — Tools",
                             "bn": "🎨 এডিটর — টুল"},
    "set_sec_sc_actions":   {"en": "⚡ Editor — Actions",
                             "bn": "⚡ এডিটর — অ্যাকশন"},
    "set_sc_help":          {"en": "Type the key combo (e.g. ctrl+shift+a, alt+p, f5, escape). Single-letter shortcuts are NOT allowed — every shortcut must include a modifier (ctrl / alt / shift) or be a function key. Changes take effect after re-opening the editor.",
                             "bn": "কী কম্বিনেশন টাইপ করুন (যেমন ctrl+shift+a, alt+p, f5, escape)। সিঙ্গেল-লেটার শর্টকাট অনুমোদিত নয় — প্রতিটা শর্টকাটে modifier (ctrl / alt / shift) থাকতে হবে অথবা function key হতে হবে। পরিবর্তন এডিটর পুনরায় খোলার পর কার্যকর হবে।"},
    "set_sc_invalid":       {"en": "Single-letter shortcuts are not allowed. Use a modifier (ctrl / alt / shift) or a function key (f1–f12) or a special key (escape).",
                             "bn": "সিঙ্গেল-লেটার শর্টকাট অনুমোদিত নয়। modifier (ctrl / alt / shift) বা function key (f1–f12) বা special key (escape) ব্যবহার করুন।"},
    "set_sc_reset":         {"en": "Reset to defaults", "bn": "ডিফল্টে ফিরে যান"},
    # Action labels (one per shortcut)
    "sc_ai_assistant":      {"en": "AI Assistant",          "bn": "AI সহায়ক"},
    "sc_smart_paste":       {"en": "Smart Paste",           "bn": "স্মার্ট পেস্ট"},
    "sc_voice_btn1":        {"en": "Voice Button 1",        "bn": "ভয়েস বাটন ১"},
    "sc_voice_btn2":        {"en": "Voice Button 2",        "bn": "ভয়েস বাটন ২"},
    "sc_take_screenshot":   {"en": "Take Screenshot",       "bn": "স্ক্রিনশট নিন"},
    "sc_tool_select":       {"en": "Select Tool (cursor / move)",
                             "bn": "সিলেক্ট টুল (কার্সর / মুভ)"},
    "sc_tool_pen":          {"en": "Pen Tool",              "bn": "পেন টুল"},
    "sc_tool_highlighter":  {"en": "Highlighter Tool",      "bn": "হাইলাইটার টুল"},
    "sc_tool_eraser":       {"en": "Eraser Tool",           "bn": "ইরেজার টুল"},
    "sc_tool_text":         {"en": "Text / Type Tool",      "bn": "টেক্সট / টাইপ টুল"},
    "sc_tool_handwrite":    {"en": "Handwriting Tool",      "bn": "হাতে লেখা টুল"},
    "sc_tool_arrow":        {"en": "Arrow Shape (➤)",       "bn": "অ্যারো শেপ (➤)"},
    "sc_clear_all":         {"en": "Clear All / Delete (🗑)",
                             "bn": "সব মুছুন / ডিলেট (🗑)"},

    # ─────────────────────── Settings panel - Voice AI Mode ─────────────────────
    "set_sec_voice_ai":     {"en": "🌐 Voice AI Mode (per button)",
                             "bn": "🌐 ভয়েস AI মোড (প্রতি বাটনের জন্য)"},
    "set_help_voice_ai":    {"en": "Enable AI processing per button.\n• Set 'Speak in' SAME as button language → AI just cleans up (removes duplicates, fixes errors, adds punctuation)\n• Set DIFFERENT → AI translates AND cleans up\nPowered by Gemini 2.5 Flash. Switches off = raw transcription only.",
                             "bn": "প্রতিটা বাটনের জন্য AI processing চালু/বন্ধ করুন।\n• 'Speak in' বাটনের ভাষার সাথে SAME দিলে → AI শুধু পরিষ্কার করবে (ডুপ্লিকেট মুছবে, ভুল ঠিক করবে, যতিচিহ্ন যোগ করবে)\n• DIFFERENT দিলে → AI translate করবে ও পরিষ্কার করবে\nGemini 2.5 Flash চালিত। সুইচ বন্ধ = শুধু raw transcription।"},
    "set_lbl_btn1_card":    {"en": "First Button — Typing: {lang}",
                             "bn": "প্রথম বাটন — টাইপিং: {lang}"},
    "set_lbl_btn2_card":    {"en": "Second Button — Typing: {lang}",
                             "bn": "দ্বিতীয় বাটন — টাইপিং: {lang}"},
    "set_lbl_enable_ai":    {"en": "Enable AI processing",
                             "bn": "AI processing চালু করুন"},
    "set_lbl_speak_in":     {"en": "Speak in:",
                             "bn": "কথা বলুন:"},

    # ─────────────────────── Settings panel - Bengali Input ─────────────────────
    "set_sec_bn_input":     {"en": "🅰️ Bengali Phonetic Input (Avro-style)",
                             "bn": "🅰️ বাংলা ফোনেটিক ইনপুট (অভ্র-style)"},
    "set_help_bn_input":    {"en": "Type Bengali phonetically in ANY Windows app — no separate Avro/Bijoy install needed. Example: 'amar nam Rahul' → 'আমার নাম রাহুল'. Powered by the official Avro Phonetic engine (avro-py, MIT-licensed). Toggle with the hotkey below.",
                             "bn": "যে কোনো Windows app-এ ফোনেটিক বাংলা টাইপ করুন — Avro/Bijoy আলাদা install লাগবে না। উদাহরণ: 'amar nam Rahul' → 'আমার নাম রাহুল'। অভ্রর official Phonetic engine ব্যবহার (avro-py, MIT-licensed)। নিচের hotkey দিয়ে toggle করুন।"},
    "set_lbl_bn_enable":    {"en": "Enable Bengali Input",
                             "bn": "বাংলা ইনপুট চালু করুন"},
    "set_lbl_bn_hotkey":    {"en": "Toggle hotkey (English ↔ Bengali):",
                             "bn": "টগল হটকি (English ↔ বাংলা):"},
    "sc_bengali_input_toggle": {"en": "Bengali Input Toggle (English ↔ Bengali)",
                                "bn": "বাংলা ইনপুট টগল (English ↔ বাংলা)"},
    "set_sc_capturing":     {"en": "Press a key combo...",
                             "bn": "কী কম্বিনেশন চাপুন..."},
    "set_sc_capture_hint":  {"en": "Click to record a new shortcut",
                             "bn": "নতুন শর্টকাট রেকর্ড করতে ক্লিক করুন"},
    "sc_editor_undo":       {"en": "Undo",                  "bn": "আনডু"},
    "sc_editor_redo":       {"en": "Redo",                  "bn": "রিডু"},
    "sc_editor_save":       {"en": "Save",                  "bn": "সেভ"},
    "sc_editor_screenshot": {"en": "Editor Screenshot",     "bn": "এডিটর স্ক্রিনশট"},
    "sc_editor_close":      {"en": "Exit Tool Panel / Close", "bn": "টুল প্যানেল প্রস্থান / বন্ধ"},
